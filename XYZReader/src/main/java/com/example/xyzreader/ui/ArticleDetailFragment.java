...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCollapsingToolbarLayout.setExpandedTitleColor(ContextCompat.getColor(mRootView.getContext()
                , R.color.colorWhite));
        mCollapsingToolbarLayout.setCollapsedTitleTextColor(ContextCompat.getColor(mRootView.getContext()
                , R.color.colorWhite));
